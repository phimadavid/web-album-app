               ...
               <div className="flex-1 mb-10 lg:mb-0">
                  <div className="text-center max-w-5xl mx-auto">
                     <h1 className="text-4xl lg:text-[2.5rem] leading-[3.5rem] font-bold mb-6">
                        Create Beautiful Digital Albums Fast Using A.I and That
                        Last Forever
                     </h1>
                     <p className="text-lg text-gray-600 mb-8">
                        Design professional-quality photo albums with our
                        intuitive tools. Perfect for weddings, family memories,
      ...
      >
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-right mb-16">
               <h2 className="text-3xl font-bold mb-4">Album Format Pricing</h2>
               <p className="text-xl text-gray-600">
                           ...
                           {hoveredFormat === index && (
                              <div className="absolute right-0 top-6 w-80 bg-gray-900 text-white p-4 rounded-lg shadow-xl z-10 text-sm">
                                 <h4 className="font-semibold mb-2">
                                    {format.hoverInfo.title}
                                 </h4>
                                 <ul className="space-y-1">
                                    {format.hoverInfo.details.map(
                                       (detail, detailIndex) => (
                                          <li
                                             key={detailIndex}
