          ...
          <div className="lg:w-1/2 order-2 lg:order-1">
            <div className="flex flex-col w-full py-5">
              <div className="mb-4 leading-9">
                <h2 className="text-4xl font-bold">Welcome to Albummai!</h2>
                <p className="text-blue-600 text-md">Create your Digital Album Book with A.I.</p>
              </div>
              <h3 className="text-lg font-semibold mb-3">Smart Features</h3>
              <ul className="space-y-2 text-sm">
                <li className="flex items-start">
                  <svg className="w-4 h-4 mr-2 mt-0.5 text-blue-300" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="mt-6 mb-10 pt-4 border-t border-blue-400 border-opacity-30">
                <p className="text-xs text-blue-500 italic">
                  "AlbummAI transformed how I organize my photo collection!" - Sarah K.
                </p>
              </div>
              <Link href="/register" className="box max-w-80 py-4 px-4 rounded-full bg-blue-700 text-center text-white">
                Create an Account
              </Link>
            </div>
          </div >
