...
const PageSlider: React.FC<PageSliderProps> = ({
                     ...
                     <div
                        ...
                        style={{
                           ...
                           fontFamily:
                              ...
                              "Arial, sans-serif",
                           fontSize:
                              parsedTextAnnotation?.style?.fontSize || "16px",
                           fontWeight:
            ...
            <div className="flex-1 flex justify-center items-center">
               {leftImage ? (
                  <div className="w-full h-full relative">
                     <div
                        onClick={() =>
                           onImageSelect && onImageSelect(leftImage, startIndex)
                        }
                        style={getContainerStyle(leftImage)}
                        className={`border-2 w-full h-full cursor-pointer transition-all duration-200 ${
               ...
               {rightImage ? (
                  <div className="w-full h-full relative">
                     <div
                        onClick={() =>
                           onImageSelect &&
                           onImageSelect(rightImage, startIndex + 1)
                        }
                        style={getContainerStyle(rightImage)}
                        className={`border-2 w-full h-full cursor-pointer transition-all duration-200 ${
                           selectedImageIndex === startIndex + 1
                              ? "border-4 border-orange-500 shadow-lg scale-105"
                              : "border-white hover:border-orange-300 hover:shadow-md"
                        }`}
                     >
            ...
            <div className="w-2/3 pr-2">
               {mainImage ? (
                  <div className="w-full h-full relative">
                     <div
                        onClick={() =>
                           onImageSelect && onImageSelect(mainImage, startIndex)
                        }
                     ...
                     {image ? (
                        <div className="w-full h-full relative">
                           <div
                              onClick={() =>
                                 onImageSelect &&
                                 onImageSelect(image, startIndex + 1 + index)
                              }
                              style={getContainerStyle(image)}
                              className={`border-2 w-full h-full cursor-pointer transition-all duration-200 ${
                                 selectedImageIndex === startIndex + 1 + index
                                    ? "border-4 border-orange-500 shadow-lg scale-105"
                                    : "border-white hover:border-orange-300 hover:shadow-md"
                              }`}
                           >
                     ...
                     {image ? (
                        <div className="relative">
                           <div
                              onClick={() =>
                                 onImageSelect &&
                                 onImageSelect(image, startIndex + index)
                              }
                              style={getContainerStyle(image)}
                              className={`w-full aspect-square mb-3 cursor-pointer transition-all duration-200 ${
                           ...
                           <>
                              ...
                              <div className="w-24 h-24 relative flex-shrink-0">
                                 <div
                                    ...
                                    style={getContainerStyle(image)}
                                    className={`border-2 w-full h-full overflow-hidden cursor-pointer transition-all duration-200 ${
                                       selectedImageIndex === startIndex + index
                                          ? "border-4 border-orange-500 shadow-lg scale-105"
                                          : "border-white hover:border-orange-300 hover:shadow-md"
                                    }`}
   ...
   const renderPageContent = (slideIndex: number) => {
      ...
      const frontPageBackground =
         pageBackgrounds[slideIndex] || albumData?.bookDesign;
      ...
      return (
         ...
         >
            ...
            <div className="absolute top-2 left-2 z-20 bg-black bg-opacity-60 text-white text-xs px-2 py-1 rounded">
               {currentPageLayout.charAt(0).toUpperCase() +
                  currentPageLayout.slice(1)}{" "}
               Layout
            </div>
            ...
            <div className="w-full h-full flex justify-center items-center relative">
               {layout === "multiple" ? (
                        ...
                        default:
                           return (
                              <div
                                 ...
                                 className={`aspect-square w-full max-w-md rounded-lg overflow-hidden relative cursor-pointer transition-all duration-200 ${
                                    selectedImageIndex === startIndex
                                       ? "border-4 border-orange-500 shadow-lg scale-105"
                                       : "border-2 border-white hover:border-orange-300 hover:shadow-md"
                                 }`}
                  ...
                  <div
                     onClick={() =>
                        onImageSelect &&
                        onImageSelect(imageData[startIndex], startIndex)
                     }
                     style={getContainerStyle(imageData[startIndex])}
                     className={`aspect-square w-full max-w-md overflow-hidden relative cursor-pointer transition-all duration-200 ${
                        selectedImageIndex === startIndex
                           ? "border-4 border-orange-500 shadow-lg scale-105"
                           : "border-2 border-white hover:border-orange-300 hover:shadow-md"
                     }`}
                  >
                     ...
                     {/* Text Annotation for single layout */}
                     {(() => {
                        const parsedTextAnnotation = parseTextAnnotation(
                           imageData[startIndex]
                        );
                        return parsedTextAnnotation &&
                           parsedTextAnnotation.position &&
         ...
         <div className="flex-1 flex flex-col items-center justify-center p-8">
            <div className="text-center">
               ...
               <p className="text-gray-600">
                  Add some photos to start editing your album
               </p>
            </div>
         </div>
      );
      ...
      <div className="flex-1 flex flex-col">
         ...
         <div className="flex-1 flex items-center justify-center p-8">
            <div className="relative w-full max-w-4xl">
               ...
               {/* Page content */}
               <div className="px-16">{renderPageContent(currentSlide)}</div>
            </div>
         </div>
