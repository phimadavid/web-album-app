...
const AIArtGeneratorPage = () => {
   ...
   const [activeTab, setActiveTab] = useState<"generate" | "history" | "saved">(
      "generate"
   );
   ...
   const saveImageToCollection = async (image: GeneratedImage) => {
      try {
         ...
         if (saveResponse.data.success) {
            ...
            throw new Error(
               saveResponse.data.error || "Failed to save image metadata"
            );
         }
      } catch (error) {
   ...
   const addToCart = async (image: GeneratedImage) => {
      try {
         ...
         if (response.data.message) {
            ...
            toast.success(
               "🎨 AI Art Print successfully added to cart! Ready for checkout."
            );
         }
      } catch (error) {
         ...
         <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-8">
               ...
               <p className="text-gray-600 text-lg">
                  Create stunning wall art with AI. Generate, save, and order
                  professional prints.
               </p>
            </div>
                  ...
                  {generatedImages.length === 0 ? (
                     <div className="text-center py-12">
                        ...
                        <p className="text-gray-500">
                           Start generating AI art to see your history here.
                        </p>
                     </div>
                  ) : (
               ...
               <div className="space-y-6">
                  {savedImages.length === 0 ? (
                     <div className="text-center py-12">
                        ...
                        <p className="text-gray-500">
                           Save your favorite generated art to see it here.
                        </p>
                     </div>
                  ) : (
                           ...
                           >
                              ...
                              <div className="flex items-center justify-between">
                                 <span className="text-xs text-gray-500">
                                    {
                                       styles.find(s => s.id === image.style)
                                          ?.name
                                    }
                                 </span>
                                 <button
