   ...
   const renderPapers = () => {
      ...
      const frontCover = (
         ...
         >
            ...
            >
               <div className="front-content w-full h-full flex flex-col justify-center items-center p-8 text-white">
            ...
            >
               ...
               >
                  ...
                  <div className="content-container w-full h-full flex justify-center items-center p-8">
                     ...
                     <div id={`f${paperIndex}`} className="front-content">
                        <h1>
                           {pages[i]?.front || `Page ${paperIndex * 2 - 1}`}
                        </h1>
                     </div>
                  </div>
               </motion.div>
               ...
               >
                  ...
                  >
                     {/* Centered content div */}
                     <div id={`b${paperIndex}`} className="back-content">
            ...
            >
               ...
               >
                  ...
                  <p className="mt-4 text-center">
                     A brief description of the book would go here. This could
                     include a synopsis, reviews, or other information about the
                     book.
                  </p>
               </div>
            </motion.div>
