                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    <button
                      ...
                      className={`p-3 flex items-center justify-center rounded-full text-sm transition-colors ${!backgroundPrompt.trim() ||
                        isGeneratingBackground
                        ? "bg-gray-300 text-gray-500 cursor-not-allowed"
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1 text-left">
                        <h5
                          className={`text-sm font-medium ${selectedLayoutId === layout.id
                            ? "text-purple-700"
                            : "text-gray-700"
                            }`}
                        >
