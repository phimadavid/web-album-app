...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.addIndex('AI_Generated_Arts', ['userId', 'isFavorite'], {
  ...
  async down(queryInterface, Sequelize) {
    ...
    await queryInterface.removeIndex('AI_Generated_Arts', 'idx_ai_art_user_id');
    await queryInterface.removeIndex('AI_Generated_Arts', 'idx_ai_art_album_id');
    await queryInterface.removeIndex('AI_Generated_Arts', 'idx_ai_art_user_favorite');
    await queryInterface.removeIndex('AI_Generated_Arts', 'idx_ai_art_public');
    await queryInterface.removeIndex('AI_Generated_Arts', 'idx_ai_art_created_at');
